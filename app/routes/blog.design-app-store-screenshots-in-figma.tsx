...
function getCTAMessage(locale: LocaleCode): string {
  switch (locale) {
    case "es":
      return "¿Cansado de reconstruir archivos de capturas en Figma en cada lanzamiento? Prueba un flujo nativo para Mac, iPad y iPhone diseñado para capturas de la App Store y Google Play.";
    case "zh":
      return "厌倦了每次发布都要重新制作 Figma 截图文件？试试专为 App Store 和 Google Play 截图打造的 Mac、iPad 和 iPhone 原生工作流。";
    case "hi":
      return "हर रिलीज़ में फिग्मा स्क्रीनशॉट फ़ाइलों को फिर से बनाने से थक गए हैं? App Store और Google Play screenshots के लिए बने नेटिव Mac, iPad और iPhone वर्कफ़्लो को आज़माएं।";
    case "fr":
      return "Fatigué de recréer vos fichiers de captures d'écran Figma à chaque version ? Essayez un flux de travail natif pour Mac, iPad et iPhone conçu pour les captures App Store et Google Play.";
    case "ar":
      return "هل سئمت من إعادة بناء ملفات لقطات شاشة Figma مع كل إصدار؟ جرب سير عمل أصليًا على Mac و iPad و iPhone مصممًا للقطات شاشة App Store و Google Play.";
    default:
      return "Tired of rebuilding Figma screenshot files every release? Try a native Mac, iPad and iPhone workflow built for App Store and Google Play screenshots.";
  }
}
...
function ContentEn() {
  return (
    <>
      ...
      <p>
        Screenshot Bro is a native Mac, iPad and iPhone app for designing, localizing,
...
function ContentEs() {
  return (
    <>
      ...
      <p>
        Screenshot Bro es una aplicación nativa de Mac, iPad e iPhone para diseñar, localizar, exportar y subir capturas de pantalla de tiendas. Te proporciona filas de dispositivos, plantillas reutilizables, localización integrada, exportación por lotes y{" "}
        <a href="/blog/upload-screenshots-to-app-store-connect">
...
function ContentZh() {
  return (
    <>
      ...
      <p>
        Screenshot Bro 是一款用于设计、本地化、导出和上传商店截图的原生 Mac、iPad 和 iPhone 应用。它为您提供设备行、可复用模板、内置本地化、批量导出以及{" "}
        <a href="/blog/upload-screenshots-to-app-store-connect">
