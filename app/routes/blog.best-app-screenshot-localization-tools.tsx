...
const TOOLS = [
  ...
  {
    tool: "Screenshot Bro",
    languages: "30 presets plus custom locale codes",
...
export default function BlogPost() {
  ...
  return (
    <BlogArticleShell
      slug={SLUG}
      locale={locale}
      tldr="For the widest language coverage, AppScreens (80+ languages) and Screenshot Studio (AI translation into any language) lead. Screenshot Bro covers 30 presets plus custom codes with on-device translation and per-shape overrides. Fastlane frameit localizes from .strings files if you already have translations."
      ctaMessage="Design once, ship in every language — 30 locales with auto-translate. Try Screenshot Bro free."
      seoLinks={[
        {
    ...
    >
      ...
      <h3>Screenshot Bro — 30 presets, on-device, override anything</h3>
      <p>
        A native Mac and iPad app with 30 language presets plus custom locale
      ...
      <p>
        More than 30 markets: <strong>AppScreens</strong> or{" "}
